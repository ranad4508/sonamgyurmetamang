      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="max-w-3xl mx-auto text-gray-600 dark:text-gray-300 text-lg">
            Hear from those whose lives have been touched by Ven. Khen
            Rinpoche's teachings and guidance.
          </p>
        </div>
                  ...
                  <Card className="border-none shadow-lg bg-white dark:bg-gray-800">
                    <CardContent className="pt-6 pb-6">
                      <div className="flex flex-col items-center text-center">
                        <Quote className="h-10 w-10 text-orange mb-4" />
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div className="text-left">
                            <p className="font-medium text-maroon dark:text-gold">
                              {testimonial.name}
                            </p>
