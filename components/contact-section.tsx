    ...
    <section className="py-20 md:py-32 bg-gray-50 dark:bg-gray-900">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            <h3 className="font-playfair text-2xl text-[#9C282A] dark:text-[#F68F30] mb-6">
              Get in Touch
            </h3>
            ...
            <form className="space-y-6">
              ...
              <Button
                type="submit"
                className="w-full bg-[#F68F30] hover:bg-[#F68F30]/90"
              >
                Send Message
              </Button>
            </form>
          ...
          >
            <div className="bg-[#1E3A5F] text-white p-8 rounded-lg shadow-md mb-8">
              <h3 className="font-playfair text-2xl text-[#EBE175] mb-6">
                Contact Information
              </h3>
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1">WhatsApp: +977 9766 883 351</p>
                  </div>
                </div>
