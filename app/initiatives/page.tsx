...
export default function InitiativesPageClient() {
  const nyungneCampaigns = [
    {
      ...
      participants: "500+",
      description:
        "A month-long series of Nyungné retreats across major cities in Japan.",
    ...
    },
    {
      ...
      participants: "350+",
      description:
        "Two-week intensive Nyungné practice program in Seoul and Busan.",
      image: "/placeholder.svg?height=400&width=600",
    },
    {
      country: "Taiwan",
      ...
      participants: "600+",
      description:
        "Virtual and in-person Nyungné retreats throughout Taiwan during the pandemic.",
      image: "/placeholder.svg?height=400&width=600",
    },
    {
      country: "Canada",
      ...
      participants: "250+",
      description:
        "Nyungné retreats in Vancouver and Toronto with emphasis on healing practices.",
      image: "/placeholder.svg?height=400&width=600",
    },
    {
      country: "USA",
      ...
      participants: "400+",
      description:
        "Multi-city tour featuring Nyungné practices and teachings on compassion.",
      image: "/placeholder.svg?height=400&width=600",
    },
  ];
  ...
  const dharmaIdealCampaign = {
    ...
    started: "2019",
    image: "/dharmaideal.png?height=600&width=800",
    objectives: [
    ...
    activities: [
      {
        ...
        description:
          "Regular forums bringing together leaders from different religious and cultural backgrounds.",
      },
      {
        title: "Educational Workshops",
        description:
          "Programs teaching practical applications of Buddhist principles in daily life.",
      },
      {
        title: "Media Productions",
        description:
          "Creating films, podcasts, and online content that share Buddhist wisdom globally.",
      },
      {
        title: "Community Service",
        description:
          "Organizing volunteer activities that embody the principle of compassion in action.",
      },
    ],
  };
    ...
    <PageTransition>
      <div className="container mx-auto px-4 py-16 md:py-24">
        ...
        <p className="text-lg text-center max-w-3xl mx-auto mb-16 text-gray-700 dark:text-gray-300">
          Venerable Khen Rinpoche's international outreach efforts aim to share
          Buddhist wisdom and foster peace and harmony across cultural and
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="font-lora text-2xl mb-4 text-maroon dark:text-amber">
                  Global Compassion Practice
                </h3>
                <p className="mb-4 text-gray-800 dark:text-gray-300">
                  Ven. Khen Rinpoche has organized meditation and teaching tours
                  across countries including Japan, Korea, Taiwan, Canada, and
                  the USA, promoting Buddhist practice and dialogue through
                  Nyungné retreats.
                </p>
                <p className="mb-4 text-gray-800 dark:text-gray-300">
                  Nyungné is a powerful fasting and purification practice
                  focused on Avalokiteshvara (Chenrezig), the Buddha of
                  Compassion. These campaigns have introduced thousands of
                  practitioners worldwide to this profound method for
                  cultivating compassion and inner peace.
                </p>
                <p className="text-gray-800 dark:text-gray-300">
                  Each campaign combines intensive practice sessions with
                  teachings on Buddhist philosophy and ethics, creating
                  transformative experiences for participants regardless of
          ...
          <Tabs defaultValue="all" className="mb-12">
                  ...
                  >
                    <Card className="h-full border-none shadow-md hover:shadow-lg transition-shadow overflow-hidden">
                      <div className="relative h-48 w-full">
                        ...
                        />
                        <div className="absolute top-0 right-0 bg-maroon text-white px-3 py-1">
                          {campaign.year}
                        </div>
                      </div>
                      <CardHeader>
            ...
            <TabsContent value="japan">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <p className="mb-4 text-gray-800 dark:text-gray-300">
                    The Japan Nyungné Campaign was a month-long series of
                    retreats across major cities including Tokyo, Kyoto, and
                    Osaka, reaching over 500 participants from diverse
                    backgrounds.
                  </p>
                  <p className="mb-4 text-gray-800 dark:text-gray-300">
                    This campaign was particularly notable for its integration
                    of Japanese cultural elements with traditional Tibetan
                    Buddhist practices, creating a unique and accessible
                    experience for Japanese practitioners.
                  </p>
                  <p className="text-gray-800 dark:text-gray-300">
                    The retreats were hosted in both traditional Buddhist
                    temples and modern meditation centers, highlighting the
                    relevance of these ancient practices in contemporary
                    Japanese society.
                  </p>
                  <div className="mt-6 bg-amber/10 p-4 rounded-lg">
                    ...
                    <ul className="space-y-1">
                      ...
                      <li className="flex items-start gap-2">
                        ...
                        <span className="text-gray-700 dark:text-gray-300">
                          Special teachings on the connection between
            ...
            <TabsContent value="korea">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  ...
                  <p className="mb-4 text-gray-800 dark:text-gray-300">
                    The Korea Nyungné Campaign consisted of a two-week intensive
                    practice program in Seoul and Busan, attracting over 350
                    participants from across the country.
                  </p>
                  <p className="mb-4 text-gray-800 dark:text-gray-300">
                    This campaign emphasized the relationship between Nyungné
                    practice and Korean Buddhist traditions, particularly the
                    cultivation of compassion as expressed in both lineages.
                  </p>
                  <p className="text-gray-800 dark:text-gray-300">
                    The program included special sessions for young
                    practitioners, introducing a new generation to these
            ...
            <TabsContent value="taiwan">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  <h3 className="font-lora text-2xl mb-4 text-maroon dark:text-amber">
                    Taiwan Campaign (2020)
                  </h3>
                  <p className="mb-4 text-gray-800 dark:text-gray-300">
                    The Taiwan Nyungné Campaign was uniquely adapted to the
                    challenges of the pandemic, offering both virtual and small
                    in-person retreats throughout the country, reaching over 600
                    participants.
                  </p>
                  <p className="mb-4 text-gray-800 dark:text-gray-300">
                    This campaign highlighted the healing aspects of Nyungné
                    practice, with special emphasis on cultivating compassion
                    during times of global crisis and uncertainty.
                  </p>
                  <p className="text-gray-800 dark:text-gray-300">
                    The innovative hybrid format allowed for unprecedented
                    participation and established new methods for sharing these
                    practices that continue to be utilized today.
                  </p>
            ...
            <TabsContent value="north-america">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  ...
                  <p className="mb-4 text-gray-800 dark:text-gray-300">
                    The North American Nyungné Campaigns included retreats in
                    major cities across Canada and the United States, reaching
                    over 650 participants combined over two years.
                  </p>
                  <p className="mb-4 text-gray-800 dark:text-gray-300">
                    These campaigns were characterized by their emphasis on
                    integrating traditional Nyungné practice with contemporary
                    Western approaches to mindfulness and compassion
                    cultivation.
                  </p>
                  <p className="text-gray-800 dark:text-gray-300">
                    The programs included special components addressing modern
                    challenges such as environmental sustainability, social
                    justice, and mental health, viewed through the lens of
                    Buddhist compassion.
                  </p>
          ...
          <div className="bg-teal/10 p-8 rounded-lg shadow-md mb-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="mb-4 text-gray-800 dark:text-gray-300">
                  The Dharma Ideal Campaign is a global initiative launched by
                  Ven. Khen Rinpoche in 2019, aiming to foster peace and harmony
                  through Buddhist teachings and community engagement.
                </p>
                <p className="mb-4 text-gray-800 dark:text-gray-300">
                  This multifaceted campaign works to make Buddhist principles
                  accessible and relevant to contemporary challenges,
                  emphasizing their practical application in daily life and
                  social contexts.
                </p>
                <p className="text-gray-800 dark:text-gray-300">
                  Through educational programs, media productions, community
                  service, and interfaith dialogues, the campaign creates
                  platforms for sharing Buddhist wisdom and building bridges
              ...
              <CardContent>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {dharmaIdealCampaign.activities.map((activity, index) => (
                    ...
                    >
                      <h4 className="font-medium text-teal dark:text-sage mb-2">
                        {activity.title}
                      </h4>
