  ...
  return (
    <PageTransition>
      <div className="container mx-auto px-4 py-16 md:py-24">
        <h1 className="font-lora text-4xl md:text-5xl text-center mb-12 text-maroon dark:text-amber">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            <h2 className="font-lora text-2xl md:text-3xl mb-6 text-crimson dark:text-orange">
        ...
        <Tabs defaultValue="early-life" className="mb-16">
          ...
          <TabsContent
            value="early-life"
            className="bg-saffron/10 p-8 rounded-lg shadow-md"
          >
            <h3 className="font-lora text-2xl mb-6 text-crimson dark:text-orange">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <p className="mb-4 text-gray-800 dark:text-gray-300">
                  ...
                  Rinpoche was recognized from an early age for his exceptional
                  spiritual qualities and deep connection to Buddhist teachings.
                </p>
                <p className="mb-4 text-gray-800 dark:text-gray-300">
                ...
                <p className="text-gray-800 dark:text-gray-300">
                  ...
                  meditation and philosophical inquiry, traits that would later
                  define his approach to teaching and sharing Buddhist wisdom.
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <p className="mb-4 text-gray-800 dark:text-gray-300">
                  ...
                  comprehensive training in Buddhist philosophy, meditation, and
                  ritual practices under the guidance of several esteemed
                  masters of the Nyingma tradition.
                </p>
                <p className="mb-4 text-gray-800 dark:text-gray-300">
                  His formal education culminated in a master's degree from the
                  prestigious Taktse Nyingma Institute in Gangtok, where he
                  excelled in advanced Buddhist studies, including Madhyamaka
                  philosophy, Abhidharma, and Tantric practices.
                </p>
                <p className="text-gray-800 dark:text-gray-300">
                  Throughout his educational journey, he was recognized for his
                  exceptional analytical abilities and deep understanding of
                  both the theoretical and practical aspects of Buddhism.
                </p>
              </div>
              <div>
                <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
                  <h4 className="font-lora text-xl mb-4 text-maroon dark:text-gold">
                    Academic Timeline
                  </h4>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      <div className="w-6 h-6 rounded-full bg-orange flex items-center justify-center text-white shrink-0 mt-1">
                        ✓
                      </div>
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span className="text-gray-800 dark:text-gray-300">
                        <strong>Advanced Studies:</strong> Specialized training
                        under renowned masters
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="w-6 h-6 rounded-full bg-orange flex items-center justify-center text-white shrink-0 mt-1">
                      ...
                      <span className="text-gray-800 dark:text-gray-300">
                        <strong>Higher Education:</strong> Master's degree from
                        Taktse Nyingma Institute, Gangtok
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="w-6 h-6 rounded-full bg-orange flex items-center justify-center text-white shrink-0 mt-1">
          ...
          <TabsContent
            value="languages"
            className="bg-crimson/10 p-8 rounded-lg shadow-md"
          >
            <h3 className="font-lora text-2xl mb-6 text-crimson dark:text-orange">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <p className="mb-4 text-gray-800 dark:text-gray-300">
                  ...
                  fluency in multiple languages, which has enabled him to share
                  Buddhist teachings across cultural and linguistic boundaries.
                </p>
                <p className="mb-4 text-gray-800 dark:text-gray-300">
                  His linguistic skills have been instrumental in translating
                  and preserving ancient Buddhist texts, making them accessible
                  to contemporary practitioners from diverse backgrounds.
                </p>
                <p className="text-gray-800 dark:text-gray-300">
                  This multilingual proficiency has allowed him to lead teaching
                  tours and establish connections with Buddhist communities
          ...
          <TabsContent
            value="achievements"
            className="bg-vermilion/10 p-8 rounded-lg shadow-md"
          >
            <h3 className="font-lora text-2xl mb-6 text-crimson dark:text-orange">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card className="bg-white/50 dark:bg-gray-800/50 border-none">
                <CardContent className="pt-6">
                  <div className="flex flex-col items-center text-center">
                    <GraduationCap className="h-10 w-10 text-maroon dark:text-gold mb-4" />
                    <h4 className="font-lora text-xl mb-2 text-maroon dark:text-gold">
                      Academic Excellence
                    </h4>
                    <p className="text-gray-800 dark:text-gray-300">
              ...
              <Card className="bg-white/50 dark:bg-gray-800/50 border-none">
                <CardContent className="pt-6">
                  <div className="flex flex-col items-center text-center">
                    <BookOpen className="h-10 w-10 text-crimson dark:text-orange mb-4" />
                    <h4 className="font-lora text-xl mb-2 text-maroon dark:text-gold">
                      Preservation Work
                    </h4>
                    <p className="text-gray-800 dark:text-gray-300">
                      ...
                      through translation, documentation, and digital archiving
                      projects.
                    </p>
                  </div>
                </CardContent>
              ...
              <Card className="bg-white/50 dark:bg-gray-800/50 border-none">
                <CardContent className="pt-6">
                  <div className="flex flex-col items-center text-center">
                    <Award className="h-10 w-10 text-orange mb-4" />
                    <h4 className="font-lora text-xl mb-2 text-maroon dark:text-gold">
                      Recognitions
                    </h4>
                    <p className="text-gray-800 dark:text-gray-300">
        ...
        >
          <h2 className="font-lora text-2xl md:text-3xl mb-6 text-center text-crimson dark:text-orange">
            Vision & Mission
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-maroon/10 p-6 rounded-lg shadow-md">
              <h3 className="font-lora text-xl mb-4 text-orange">Vision</h3>
              <p className="text-gray-800 dark:text-gray-300">
            ...
            <div className="bg-orange/10 p-6 rounded-lg shadow-md">
              <h3 className="font-lora text-xl mb-4 text-maroon dark:text-gold">
                Mission
              </h3>
              <p className="text-gray-800 dark:text-gray-300">
        ...
        <motion.div
          ...
          className="mt-16"
        >
          <h2 className="font-lora text-2xl md:text-3xl mb-8 text-center text-crimson dark:text-orange">
            Dedication to Preserving Buddhist Teachings
          </h2>
          <div className="bg-vermilion/10 p-8 rounded-lg shadow-md">
